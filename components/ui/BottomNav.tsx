...
import { Gamepad2, ShoppingBag, User, Sparkles } from 'lucide-react';
...
export function BottomNav({ activeTab }: BottomNavProps) {
  ...
  return (
    <div className="relative w-full bg-slate-900/95 backdrop-blur-xl border-t border-slate-800/80 px-4 py-2">
