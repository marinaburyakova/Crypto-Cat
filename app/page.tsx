...
export default function HomePage() {
  ...
  return (
    <div className="relative flex flex-col h-full w-full bg-slate-950 text-slate-50 overflow-hidden justify-between select-none">
      {/* ШАПКА ИГРЫ */}
      <header className="w-full bg-slate-900/70 backdrop-blur-md border-b border-slate-800/80 p-4 z-20 space-y-3">
      ...
      <div className="flex-1 relative w-full overflow-hidden flex flex-col">
        ...
        {/* ИНТЕРФЕЙС ЧАТА */}
        <div className="w-full p-4 z-20 space-y-3 bg-slate-950/40 backdrop-blur-sm rounded-t-3xl border-t border-slate-900/50">
